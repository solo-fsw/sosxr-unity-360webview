...
public class ObjectCue : MonoBehaviour
{
    ...
    //     {
    //         this.Info("Cue sequence is active, cannot restart cue sequence");
    //
    //         return;
    //     }
    //
    //     this.Success("Starting cue");
    //
    //     EventOnStart?.Invoke();
    //
    ...
    //     if (clip == null)
    //     {
    //         this.Error("We want to PlayClipAtPoint, but we haven't supplied a clip. That cannot be");
    //
    //         return;
    //     }
    //
    ...
    //     {
    //         this.Info("Cuesequence is active, cannot restart return sequence");
    //
    //         return;
    //     }
    //
