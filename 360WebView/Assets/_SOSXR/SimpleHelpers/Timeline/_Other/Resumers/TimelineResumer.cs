...
public class TimelineResumer : MonoBehaviour
{
    ...
    private bool
        _haveControl; // To make sure that only the instance called by each clip has control to start the line again.
    ...
    public void ResumeTimeline()
    {
        if (_director == null)
        {
            this.Warning("No director was present, cannot Resume");
