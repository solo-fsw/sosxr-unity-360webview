...
namespace mrstruijk.EnhancedLogger
{
    public static class InspectorCommon
    {
        ...
        {
            return GUILayout.Button(new GUIContent(text, tip), EditorStyles.toolbarButton, GUILayout.Width(width),
            ...
            ref float hiCutoff)
        {
            ...
            EditorGUILayout.LabelField(new GUIContent(inspWidth < (double) num ? shortLabel : label, tooltip),
                GUILayout.MaxWidth(maxWidth2));
