...
[TrackClipType(typeof(TMProClip))] // Bind to whatever I need to have in the Timeline
...
public class TMProTrack : TrackAsset
{
    ...
    private void SetDisplayName()
    {
        foreach (var clip in m_Clips)
        {
            ...
            clip.displayName = currentClip.text + " (" + GetColorInt(currentClip.color.r) + "," +
                               GetColorInt(currentClip.color.g) + "," +
                               GetColorInt(currentClip.color.b) + ")";
        }
    }
