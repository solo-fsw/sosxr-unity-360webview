...
namespace mrstruijk.SimpleHelpers
{
    ...
    public static class InterfaceHelper
    {
        ...
        private static void InitInterfaceToComponentMapping()
        {
            ...
            foreach (var curInterface in _allTypes)
            {
                ...
                if (typeName.Contains("unity") || typeName.Contains("system.")
                                               || typeName.Contains("mono.") || typeName.Contains("mono.") ||
                                               typeName.Contains("icsharpcode.")
                                               || typeName.Contains("nsubstitute") || typeName.Contains("nunit.") ||
                                               typeName.Contains("microsoft.")
                                               || typeName.Contains("boo.") || typeName.Contains("serializ") ||
                                               typeName.Contains("json")
                                               || typeName.Contains("log.") || typeName.Contains("logging") ||
        ...
        private static IList<Type> GetTypesInheritedFromInterface(Type type)
        {
            ...
            return _allTypes.Where(curType => type.IsAssignableFrom(curType) && curType.IsSubclassOf(typeof(Component)))
                            .ToList();
        }
