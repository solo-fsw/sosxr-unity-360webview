...
namespace Vuplex.WebView {
    ...
    public abstract class BaseWebViewPrefab : MonoBehaviour {
        ...
        [Internal.Label("Cursor Icons Enabled (Windows and macOS only)")]
        ...
        /// </list>
        /// </remarks>
        [Internal.Label("Drag Threshold (px)")]
        ...
        [Internal.Label("Initial URL (optional)")]
        ...
        [Internal.Label("Pixel Density (Windows and macOS only)")]
    ...
    #region Non-public members
        ...
        bool _videoLayerIsEnabled {
            get => _videoLayer != null && _videoLayer.gameObject.activeSelf;
            set {
                if (_videoLayer != null) {
                    _videoLayer.gameObject.SetActive(value);
                }
